...
admin.site.register(TelModel)
admin.site.register(ComputerModel)
admin.site.register(TabletModel)
admin.site.register(CableInternet)
admin.site.register(CableInternetProvider)
admin.site.register(MobileInternet)
admin.site.register(MobileInternetProvider)